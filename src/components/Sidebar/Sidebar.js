...
import DarkLightSwitch from "../Navbars/DarkLightSwitch";
  ...
  return (
    <Box ref={mainPanel}>
      <Box display={{ sm: "none", xl: "block" }} position="absolute">
        ...
        >
          <Box key={`box-sidebar-brand`}>{brand}</Box>
        ...
        >
          ...
          <DrawerBody maxW="250px" px="1rem">
            <Box maxW="100%" h="100vh">
              ...
              <Separator></Separator>
                <Flex mt="20px" alignItems="center" display={{ sm: "flex", xl: "none" }} mb="20px">
                  <Icon ml="15px" as={FaPalette} color="teal.500"/>
                  <Text ml="15px" color={"gray.400"} fontWeight="600" my="auto" fontSize="sm">
                    Theme
                  </Text>
                  <DarkLightSwitch ml="15px"/>
                </Flex>
              <SidebarHelp></SidebarHelp>
            </Box>
          </DrawerBody>
